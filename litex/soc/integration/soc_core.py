...
def soc_core_args(parser):
    ...
    soc_group.add_argument("--bus-bursting",      default=False, action=bool_action, help="Enable burst cycles on the bus if supported.")
    ...
    # Controller parameters
    soc_group.add_argument("--ctrl", default=True, action=bool_action, help="Include Controller.")
    ...
    soc_group.add_argument("--ident-version", default=True, action=bool_action, help="Include date/time in SoC identifier.")

    # UART parameters
    soc_group.add_argument("--uart",            default=True, action=bool_action, help="Include a UART.")
    ...
    # Timer parameters
    soc_group.add_argument("--timer",           default=True, action=bool_action,  help="Include a Timer.")
    soc_group.add_argument("--timer-uptime",    default=False, action=bool_action, help="Add an uptime capability to Timer.")
